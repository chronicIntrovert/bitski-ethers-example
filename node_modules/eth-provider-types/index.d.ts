...
export declare enum EthBlockNumberTag {
    Latest = "latest",
    Earliest = "earliest",
    Pending = "pending"
}
...
export declare type EthTransaction = EthTransactionComplete | EthTransactionPending;
...
export declare type EthTopic = string | null | [string, string];
...
export declare type EthLog = EthLogComplete | EthLogPending;
...
export declare type EthBlock<T extends boolean = boolean> = EthBlockComplete<T> | EthBlockPending<T>;
export declare type EthGetBlockParams<T extends boolean> = [
...
export declare type TypedDataDefinition = TypedPropertyDef[];
...
/***** RPC Errors *****/
export declare enum EthProviderRpcErrorCode {
...
export declare enum EthProviderMessageType {
...
export declare type EthProviderMessageData = {
...
export declare type EthEventParams = {
    ...
    [EthEvent.data]: [null, {
        params: EthSubscriptionData;
    }];
};
/***** Provider *****/
export declare type EthRequest<T extends EthMethod = EthMethod> = EthMethodParams[T] extends void ? {
    method: T;
    params?: [];
} : {
    method: T;
...
export declare type EthResult<T extends EthMethod> = Promise<EthMethodResults[T]>;
export declare type EthEventListener<T extends EthEvent> = (...params: EthEventParams[T]) => void;
