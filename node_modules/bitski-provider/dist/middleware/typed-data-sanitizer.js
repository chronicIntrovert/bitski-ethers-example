...
export const createTypedDataSanitizerMiddleware = () => {
...
const sanitizeRequest = (payload) => {
    ...
    if (!params || params.length < 2) {
        throw ethErrors.provider.userRejectedRequest(`Missing params for ${payload.method}. The first parameter should be the address of the account to sign with, and the second parameter should be the data to sign.`);
    }
 ...
 */
export const sanitizeDomain = (typedData, typeMapping) => {
 ...
 * @param typeMapping a TypeMapping pre-generated from the TypedData
 */
export const sanitizeMessage = (typedData, typeMapping) => {
...
export const sanitizeType = (typeName, values, typeMapping) => {
