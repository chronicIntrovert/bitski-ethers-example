...
export const ZkSyncEra = makeChainDef(324, 'zkSync Era', 'https://explorer.zksync.io');
export const ZkSyncEraTestnet = makeChainDef(280, 'zkSync Era Testnet', 'https://goerli.explorer.zksync.io');
export const BinanceSmartChain = makeChainDef(56, 'BinanceSmartChain', 'https://bscscan.com/');
export const BinanceSmartChainTestnet = makeChainDef(97, 'BinanceSmartChainTestnet', 'https://testnet.bscscan.com/');
