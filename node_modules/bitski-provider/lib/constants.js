...
].map(parse_utils_1.toHex);
const makeChainDef = (chainId, chainName, blockExplorerUrl) => ({
    chainId: (0, parse_utils_1.toHex)(chainId),
    rpcUrls: [`https://api.bitski.com/v1/web3/chains/${chainId}`],
    chainName,
    blockExplorerUrls: [blockExplorerUrl],
});
exports.Mainnet = makeChainDef(1, 'Mainnet', 'https://etherscan.io/');
exports.Goerli = makeChainDef(5, 'Görli', 'https://goerli.etherscan.io/');
exports.Polygon = makeChainDef(137, 'Polygon', 'https://polygonscan.com/');
...
exports.ZkSyncEra = makeChainDef(324, 'zkSync Era', 'https://explorer.zksync.io');
exports.ZkSyncEraTestnet = makeChainDef(280, 'zkSync Era Testnet', 'https://goerli.explorer.zksync.io');
exports.BinanceSmartChain = makeChainDef(56, 'BinanceSmartChain', 'https://bscscan.com/');
exports.BinanceSmartChainTestnet = makeChainDef(97, 'BinanceSmartChainTestnet', 'https://testnet.bscscan.com/');
exports.DEFAULT_CHAINS = [
    exports.Mainnet,
    exports.Goerli,
    exports.Polygon,
