...
exports.toHex = exports.encodeNumber = void 0;
...
function parseNumber(arg) {
    ...
    if (type === 'string' || type === 'number') {
        ...
        throw eth_rpc_errors_1.ethErrors.rpc.invalidInput('Argument is not a number');
    }
}
function parseBitWidth(type, offset) {
    ...
    if (size % 8 || size < 8 || size > 256) {
        throw eth_rpc_errors_1.ethErrors.rpc.invalidInput(`Invalid bit width ${type}`);
    }
    return size;
}
/**
...
function encodeNumber(num, type, compact = false) {
    if (type.startsWith('uint')) {
        ...
        if (parsed < BigInt(0)) {
            throw eth_rpc_errors_1.ethErrors.rpc.invalidInput('Supplied uint is negative');
        }
        ...
        throw eth_rpc_errors_1.ethErrors.rpc.invalidInput('Invalid type passed');
    }
}
