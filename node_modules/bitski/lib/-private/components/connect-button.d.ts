...
export declare class ConnectButton {
     ...
     */
    constructor(loadSDK: () => Promise<Pick<BitskiSDK, 'signInOrConnect'> | null>, options?: ConnectButtonOptions, callback?: (error?: Error, user?: any) => void, getProvider?: (() => BitskiProviderShim) | undefined);
    /**
