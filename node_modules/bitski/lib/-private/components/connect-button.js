...
class ConnectButton {
    ...
    constructor(loadSDK, options, callback, getProvider) {
        ...
        this.authIntegrationType = options.authMethod || constants_1.OAuthSignInMethod.Popup;
    ...
    async signin() {
        ...
        try {
            ...
            if (error instanceof Error && error.message === oauth_manager_1.USER_CANCELLED_MESSAGE) {
