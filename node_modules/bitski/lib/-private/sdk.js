...
const connect_button_1 = __importDefault(require("./styles/connect-button"));
/**
 * Bitski SDK
 */
class BitskiSDK {
    ...
    constructor(clientId, redirectUri, additionalScopes, options) {
        ...
        this.store = (options === null || options === void 0 ? void 0 : options.store) || new bitski_provider_1.LocalStorageStore();
        this.authProvider = new openid_auth_provider_1.OpenidAuthProvider(clientId, redirectUri || window.location.href, this.store, additionalScopes, options === null || options === void 0 ? void 0 : options.configuration);
     ...
     */
    signIn(options) {
        return this.authProvider.signIn(constants_1.OAuthSignInMethod.Popup, options);
    }
    /**
    ...
    signInRedirect(options) {
        this.authProvider.signIn(constants_1.OAuthSignInMethod.Redirect, options);
    }
    /**
    ...
    injectStyles() {
        ...
        style.appendChild(document.createTextNode(connect_button_1.default));
