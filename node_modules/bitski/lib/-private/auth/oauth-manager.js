...
exports.OAuthManager = exports.USER_CANCELLED_MESSAGE = exports.LOGIN_HINT_SIGNUP = void 0;
...
exports.USER_CANCELLED_MESSAGE = 'Sign in request was cancelled.';
/**
        ...
        if (this.pendingResolver) {
            if (response) {
                ...
                if (errorResponse instanceof popup_handler_1.PopupClosedError) {
                    this.pendingResolver.reject(new Error(exports.USER_CANCELLED_MESSAGE));
                }
