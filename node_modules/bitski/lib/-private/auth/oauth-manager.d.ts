import { type AuthorizationError, AuthorizationNotifier, AuthorizationRequest, type AuthorizationRequestHandler, type AuthorizationResponse, AuthorizationServiceConfiguration, TokenRequest, type TokenRequestHandler, type TokenResponse } from '@openid/appauth';
...
export declare const USER_CANCELLED_MESSAGE = "Sign in request was cancelled.";
/**
