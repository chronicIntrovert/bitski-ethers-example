...
import type { BitskiSDKOptions, ProviderOptions } from './-private/sdk';
...
import { BinanceSmartChain, BinanceSmartChainTestnet, Goerli, Mainnet, Mumbai, Network, Polygon } from './-private/network';
...
export { type Network, BinanceSmartChain, BinanceSmartChainTestnet, Mainnet, Goerli, Polygon, Mumbai, AuthenticationStatus, OAuthSignInMethod, };
export declare class Bitski {
     ...
     */
    constructor(clientId: string, redirectUri?: string | undefined, additionalScopes?: string[] | undefined, options?: BitskiSDKOptions | undefined);
    /**
     ...
     */
    addSignOutHandler(fn: () => void): Promise<void>;
    /**
     * Remove a registered signout callback
     * @param fn Your callback function
     */
    removeSignOutHandler(fn: () => void): Promise<void>;
    /**
